...
export const metadata: Metadata = { title: "VINSKAPE | Interior Design & Architecture", description: "Thoughtful, elegant and functional interiors for homes, commercial spaces and modern workplaces." };
